...
export const destinations: Destination[] = [
  ...
  { id: 'meili', name: '飞来寺·梅里', subtitle: '车宿一晚等金山', description: '主线在飞来寺车宿一晚，清晨等候卡瓦格博的日照金山后前往丽江。', duration: '1晚', theme: '日照金山', coordinates: { x: 145, y: 110 }, icon: '🌄', recommendations: ['白马雪山', '飞来寺', '日照金山'], images: [] },
...
export const hotelsData: HotelExtended[] = [
  ...
  { id: 'hotel-feilai', name: '飞来寺｜住宿未预订', location: '德钦·飞来寺附近', price: '—', rating: 0, tags: ['1晚', '观景便利'], reason: ['方便清晨看日照金山', '需确认观景与停车条件'], distance: [], image: '', oxygen: false, heating: true, parking: true, lat: 28.45, lng: 98.88, confirmed: false, confirmedTags: ['待预订', '1晚'], city: '梅里雪山' },
