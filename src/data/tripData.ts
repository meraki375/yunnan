...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    hotel: pendingHotel('昆明｜住宿未预订', '昆明'),
    ...
    schedule: [
      ...
      { time: '18:30', activity: '抵达昆明，办理待定住宿', type: 'afternoon' },
...
export const destinations: Destination[] = [
  ...
  { id: 'kunming', name: '昆明', subtitle: '春城一夜', description: '只住一晚、酒店尚未确定；抵达后逛夜市，再向大理出发。', duration: '1晚', theme: '夜市', coordinates: { x: 390, y: 330 }, icon: '🌃', recommendations: ['昆明夜市', '过桥米线', '早点休息'], images: [] },
...
export const hotelsData: HotelExtended[] = [
  ...
  { id: 'hotel-kunming', name: '昆明｜住宿未预订', location: '昆明', price: '—', rating: 0, tags: ['1晚', '逛夜市后入住'], reason: ['只住一晚', '抵达时间视路况而定'], distance: [], image: '', oxygen: false, heating: false, parking: true, lat: 25.04, lng: 102.71, confirmed: false, confirmedTags: ['待预订', '1晚'], city: '昆明' },
